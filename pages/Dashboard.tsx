          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                      ...
                      <button onClick={() => navigate('/contracts')} className="text-xs font-medium text-gray-500 hover:text-gray-900">View All</button>
                  </div>
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {recentContracts.length === 0 ? (
                                <tr><td colSpan={4} className="px-6 py-8 text-center text-gray-400 italic">No contracts found.</td></tr>
                            ) : (
                                recentContracts.map(c => (
                                    <tr key={c.id} className="hover:bg-gray-50 transition-colors cursor-pointer group" onClick={() => navigate('/contracts')}>
                                        ...
                                        <td className="px-6 py-4 text-gray-600">
                                            {/* In a real app we'd lookup client name, mock for now */}
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                      ...
                      <button onClick={() => navigate('/tasks')} className="text-xs font-medium text-gray-500 hover:text-gray-900">View Board</button>
                  </div>
                  <div className="divide-y divide-gray-100">
                        {recentTasks.length === 0 ? (
                            <div className="px-6 py-8 text-center text-gray-400 italic">All caught up! No pending tasks.</div>
                        ) : (
          ...
          <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 text-white shadow-lg relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                      <div className="flex items-center gap-2 mb-3">
                          ...
                          <h3 className="font-semibold text-lg">Firm Identity AI</h3>
                      </div>
                      <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                          {hasStyleProfile 
                            ? "Your firm's writing style is active. All new contracts will be generated using your unique tone and structure."
                            : "Your firm's style profile is missing. Upload past documents to train the AI on your writing identity."}
                      </p>
                      ...
                      >
                          {hasStyleProfile ? 'Manage Style Profile' : 'Train AI Now'}
                      </button>
                  </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                      <button onClick={() => navigate('/clients')} className="p-3 rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all text-left group">
                          ...
                          <span className="block text-sm font-medium text-gray-700 group-hover:text-blue-700">Add Client</span>
                      </button>
                      <button onClick={() => navigate('/contracts')} className="p-3 rounded-lg border border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-all text-left group">
                          ...
                          <span className="block text-sm font-medium text-gray-700 group-hover:text-purple-700">Draft Contract</span>
                      </button>
                      <button onClick={() => navigate('/tasks')} className="p-3 rounded-lg border border-gray-200 hover:border-orange-500 hover:bg-orange-50 transition-all text-left group">
                          ...
                          <span className="block text-sm font-medium text-gray-700 group-hover:text-orange-700">New Task</span>
                      </button>
                      <button onClick={() => navigate('/calendar')} className="p-3 rounded-lg border border-gray-200 hover:border-green-500 hover:bg-green-50 transition-all text-left group">
                          ...
                          <span className="block text-sm font-medium text-gray-700 group-hover:text-green-700">Schedule</span>
                      </button>
                  </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                  <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Today's Agenda</h3>
                      <button onClick={() => navigate('/calendar')} className="text-gray-400 hover:text-gray-900"><Icons.ChevronRight size={16} /></button>
                  </div>
                  <div className="space-y-3">
                      {todayEvents.length === 0 ? (
                          <p className="text-xs text-gray-400 italic">No events scheduled for today.</p>
                      ) : (
                          todayEvents.map(evt => (
                              <div key={evt.id} className="flex gap-3 items-start">
                                  ...
                                  <div className="pb-3">
                                      ...
                                      <p className="text-xs text-gray-500 mt-1">{evt.location || 'Remote'}</p>
                                  </div>
                              </div>
                          ))
                      )}
